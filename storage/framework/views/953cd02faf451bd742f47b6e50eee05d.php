...
unset($__errorArgs, $__bag); ?>
                                ...
                                <select id="select2" name="options[]"  class="hidden" multiple>
                                    ...
                                    <option value="<?php echo e($item->Name); ?>"  <?php echo e($apartement->options && in_array($item->Name,json_decode($apartement->options)) ? 'selected' : ''); ?>><?php echo e($item->Name); ?></option>
...
</html><?php /**PATH C:\Users\ISTA TASSILA 3\Desktop\pfe 2\resources\views/editApartement.blade.php ENDPATH**/ ?>