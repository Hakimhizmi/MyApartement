<nav id="header" class="w-full z-30 top-0 py-1">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
      ...
      <div class="order-1 md:order-2">
        <a href="/main" class="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl " >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="black" class="w-8 h-8 mr-2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
      ...
      <div class="order-2 md:order-3 flex items-center" id="nav-content">
        ...
        <?php if(auth()->guard()->check()): ?> 
        <div data-dropdown-toggle="dropdown1" class="flex items-center ml-2 mt-1 relative cursor-pointer whitespace-nowrap">Admin</div>
        <?php endif; ?>
        <div id="dropdown1" class="z-10 hidden w-92 p-3 bg-white rounded-lg shadow-2xl ">
          <div class="w-72">
          <?php if(auth()->guard()->guest()): ?> 
            <form class="mt-4" action="<?php echo e(route('login')); ?>" method="post">
              ...
              <button type="submit" class="mb-1.5 mt-2 block w-full text-center text-white bg-purple-700 hover:bg-purple-900 px-2 py-1.5 rounded-md">Sign in</button>
  ...
  </nav><?php /**PATH C:\Users\ISTA TASSILA 3\Desktop\pfe 2\resources\views/nav.blade.php ENDPATH**/ ?>