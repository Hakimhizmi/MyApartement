                ...
                <table class="min-w-max w-full table-auto">
                    ...
                    <tbody class="text-gray-600 text-sm font-light" id="tableOptions">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <span><?php echo e($item->name); ?> <?php echo e($item->lastName); ?></span>
                                </div>
                            </td>
                            <td class="py-3 px-6 text-left">
                                <div class="flex items-center">
                            ...
                            <td class="flex items-center px-6 py-3 font-medium">
                                    <img class="object-cover w-10 h-10 mr-4 rounded-lg"
                                        src="/images/<?php echo e($item->cover); ?>" alt="">
                                    <div>
                                        <p class="text-sm  font-medium "><?php echo e($item->title); ?></p>
                                    </div>
                            </td>
                            <td class="py-3 px-6 text-left">
                                <span
                                    class="inline-block px-2 py-1 text-center  <?php echo e($item->status == 0 ? 'text-red-600 bg-red-100' : 'text-green-600 bg-green-100'); ?>  rounded-full ">
                                    <?php echo e($item->status == 0 ? 'unread' : 'read'); ?></span>
                            </td>
                            <td class="mx-auto float-right mr-10 mt-1 mb-1">
                               <a href="<?php echo e(route('dashboard.detailOrder',$item->id)); ?>"> <button class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">Detail</button></a>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
...
</html><?php /**PATH C:\Users\Administrator\Desktop\pfe 2\resources\views/dashboard.blade.php ENDPATH**/ ?>