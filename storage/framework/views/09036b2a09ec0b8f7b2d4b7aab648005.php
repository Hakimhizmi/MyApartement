...
#carousel-3:checked ~ .control-3 ~ .carousel-indicators li:nth-child(3) .carousel-bullet {
  ...
  <?php echo $__env->make('last', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <a id="dropdownDefault" data-dropdown-toggle="dropdown" class="pl-3 inline-block no-underline hover:text-black" href="#">
...
<h6 class="mb-1 text-sm font-medium text-gray-900 dark:text-white">
  ...
  <option value="desc">price , decending</option>
      ...
      <div class="flex" id="apartements">
      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="<?php echo e($item->cover); ?>">
                    <div class="pt-3 flex items-center justify-between">
                        <p class=""><?php echo e($item->title); ?></p>
                        
                    </div>
                    <p class="pt-1 text-gray-900"><?php echo e($item->price); ?></p>
                </a>
            </div>
...
<script>
  function filter() {
    ...
    $.ajax({
      type: 'POST',
      url: `<?php echo e(route('agence.filter')); ?>`,
      data: {surface_filter,rooms_filter,price_filter,search},
      headers: {
      ...
      success: function(data) {
        ...
        data.data.forEach(item => {
          ...
          <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="${item.cover}">
                    <div class="pt-3 flex items-center justify-between">
...
<?php /**PATH C:\Users\ISTA TASSILA 3\Desktop\project_agence\back-end\resources\views/main.blade.php ENDPATH**/ ?>