    ...
    <div class="flex flex-wrap -mx-6" id="apartements">
      ...
      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="/main/<?php echo e($item->id); ?>">
                  <div class="relative ">
                    <img class="hover:grow   hover:shadow-lg" src="images/<?php echo e($item->cover); ?>">
...
<script>
  function filter() {
    ...
    $.ajax({
      type: 'POST',
      url: `<?php echo e(route('main.filter')); ?>`,
...
<?php /**PATH C:\Users\ISTA TASSILA 3\Desktop\pfe 2\resources\views/main.blade.php ENDPATH**/ ?>