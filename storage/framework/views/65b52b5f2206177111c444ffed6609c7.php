...
<div class="flex min-h-screen items-center justify-start bg-white" id="form" style="display: none;">
    ...
    <div class="mx-auto w-full max-w-lg">
      ...
      <form  class="mt-10" action="<?php echo e(route('main.order',$data->id)); ?>" method="post">
      <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Administrator\Desktop\pfe 2\resources\views/detail.blade.php ENDPATH**/ ?>