                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[30%,1fr] gap-6">
                        <div>
                            ...
                            <div class="mb-6 mt-5 lg:mb-10 lg:h-2/4 ">
                                <img src="/images/{{$apartement->cover}}" alt="" id="cover"
                                    class="object-cover w-full lg:h-full rounded-lg shadow-lg">
                            </div>
                        </div>
                        <div>
                            <form action="{{route('dashboard.update',$apartement->id)}}" method="post" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                

                                <input type="text" name="defaulimage" value="{{$apartement->cover}}" hidden />  
                                <div class="px-4 mb-6">
                                    ...
                                    <input
                                        ...
                                        type="text" name="title" placeholder="Enter a title" value="{{$apartement->title}}">
                                        @error('title')
                                ...
                                <div class="flex flex-wrap items-center">
                                    <div class="w-full px-4 mb-6 lg:w-2/4">
                                        ...
                                        <input
                                        class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                        type="number" name="surface" placeholder="Enter a surface" value="{{$apartement->surface}}">
                                        @error('surface')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="w-full px-4 mb-6 lg:w-2/4">
                                        <label class="block mb-2 text-sm font-medium "> Price
                                            <input
                                            class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                            type="number" name="price" placeholder="Enter a price" value="{{$apartement->price}}">
                                            @error('price')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="flex flex-wrap items-center">
                                    <div class="w-full px-4 mb-6 lg:w-1/3">
                                        ...
                                        <input
                                        class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                        type="number" name="pieces" placeholder="Enter a pieces" value="{{$apartement->pieces}}">
                                        @error('pieces')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="w-full px-4 mb-6 lg:w-1/3">
                                        <label class="block mb-2 text-sm font-medium "> Floor
                                            <input
                                            class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                            type="number" name="floor" placeholder="Enter a floor" value="{{$apartement->floor}}">
                                            @error('floor')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="w-full px-4 mb-6 lg:w-1/3">
                                        <label class="block mb-2 text-sm font-medium "> Rooms
                                            <input
                                            class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                            type="number" name="rooms" placeholder="Enter a rooms" value="{{$apartement->rooms}}">
                                            @error('rooms')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="flex flex-wrap items-center">
                                    <div class="w-full px-4 mb-6 lg:w-1/3">
                                        ...
                                        <input
                                        class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                        type="text" name="city" placeholder="Enter a city" value="{{$apartement->city}}">
                                        @error('city')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="w-full px-4 mb-6 lg:w-1/3">
                                        <label class="block mb-2 text-sm font-medium "> Adresse
                                            <input
                                            class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                            type="text" name="adresse" placeholder="Enter a adresse" value="{{$apartement->adresse}}">
                                            @error('adresse')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="w-full px-4 mb-6 lg:w-1/3">
                                        <label class="block mb-2 text-sm font-medium "> Postal Code
                                            <input
                                            class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg  "
                                            type="number" name="postalcode" placeholder="Enter a postal code" value="{{$apartement->postalcode}}">
                                            @error('postalcode')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="px-4 mb-6">
                                    ...
                                    <textarea
                                        class="block w-full px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border border-gray-300 rounded-lg "
                                        name="description" rows="5" placeholder="Write something..."  >{{$apartement->description}}</textarea>
                                        @error('description')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>{{$message}}</p>
                                        @enderror
                                </div>
                                ...
                                <select id="select2" name="options[]"  class="hidden" multiple>
                                    ...
                                    <option value="{{$item->id}}"  {{ in_array($item->id, $apartementOptions->pluck('id')->toArray()) ? 'selected' : '' }}>{{$item->Name}}</option>
                                    @endforeach
                                </select>
