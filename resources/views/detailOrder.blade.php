      ...
      <div class="md:flex-1 px-4">
        <div class="w-full px-6 mb-10 lg:w-2/2 lg:mb-0 ">
            <div class="pl-4 mb-6 border-l-4 border-blue-500 ">
                <span class="text-sm text-gray-600 uppercase ">{{$data->date}}</span>
